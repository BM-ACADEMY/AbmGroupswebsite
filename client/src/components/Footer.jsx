    ...
    >
      <div className="flex flex-col md:flex-row items-start justify-between gap-6 md:gap-10 py-10 border-b border-gray-500/30 text-gray-500">
        ...
        <div className="flex-1 min-w-[200px] md:min-w-[250px]">
          ...
          {/* Social Icons */}
          {/* <div className="mt-6">
            <h3 className="font-semibold text-base text-gray-300 mb-3">Follow Us</h3>
            <ul className="flex gap-4 text-lg text-gray-400">
              <li><a href="https://www.instagram.com/bmacademypondy/" target="_blank" className="hover:text-yellow-400 transition"><Instagram size={20} /></a></li>
              <li><a href="https://x.com/BMACADEMYPONDY" target="_blank" className="hover:text-yellow-400 transition"><Twitter size={20} /></a></li>
              <li><a href="https://www.facebook.com/people/BM-Academy/61566753898165/" target="_blank" className="hover:text-yellow-400 transition"><Facebook size={20} /></a></li>
              <li><a href="https://www.youtube.com/@bmacademypondy" target="_blank" className="hover:text-yellow-400 transition"><Youtube size={20} /></a></li>
            </ul>
          </div> */}
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between w-full md:w-[65%] gap-6 md:gap-10">
          ...
          <div className="flex-1 min-w-[120px] md:min-w-[150px]">
            ...
            <ul className="text-sm text-gray-400 space-y-1">
              ...
              <li>
                <a href="#moments" className="hover:underline transition">
                  Moments
                </a>
              </li>
              <li>
                <a href="#brands" className="hover:underline transition">
                  Brands
                </a>
              </li>
